...
const _state = {
   ...
   * '/' is the Dashboard (map). '/profile', '/group', '/settings',
   * '/contributions', and '/notifications' are page views.
   */
  currentRoute: '/',            // '/' | '/profile' | '/group' | '/settings' | '/contributions' | '/notifications'
